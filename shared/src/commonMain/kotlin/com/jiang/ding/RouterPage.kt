...
import com.jiang.ding.base.BasePager
import com.jiang.ding.base.bridgeModule
import com.jiang.ding.base.Utils
import com.jiang.ding.components.AppMiniButton
...
internal fun ComposeRouteImpl() {
    ...
    Column(
        ...
        AppMiniButton({
            Utils.bridgeModule(localPager.pagerId).toast("获取手机号成功：$it")
        })
    }
}
